...
public class JoueurControlleur : MonoBehaviour
{
    [HideInInspector]
    public float vitesse = 7;

    [HideInInspector]
    public float saut = 50;
    ...
    /// <summary>
    /// Trouve les boutons peser par l'utilisateur et anim le joueur en conséquence
    /// </summary>
    void GetInput()
    {
    ...
    /// <summary>
    /// Calcul la direction dans laquelle il faut déplacer le joueur
    /// </summary>
    ...
    /// <summary>
    /// Tourne le joueur en focntion de la caméra
    /// </summary>
    void Tourner()
    {
